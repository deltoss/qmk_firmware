...
#define MAKE_COMMAND "make keychron/q3_pro/ansi_encoder:via:flash"
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_BASE] = LAYOUT_tkl_f13_ansi(
        KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,     KC_MUTE,    KC_PSCR,  TG(MOUSE_LAYER), RGB_MOD,
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,     KC_BSPC,    KC_INS,   KC_HOME,  KC_PGUP,
    ...
    [NAVIGATIONS_LAYER] = LAYOUT_tkl_f13_ansi(
        ...
        _______,  MT_HL_LINE, MT_HL_LEFT, MT_HL_DOWN, MT_HL_RIGHT,  KC_BSPC,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_HOME,  KC_END,               _______,
        _______,            LINE_BSPC, WORD_BSPC, KC_BSPC,_______,  _______,  _______,  KC_DEL,  WORD_DEL,  LINE_DEL, KC_END,              _______,              _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,    _______,    _______,  _______,  _______),
     ...
     */
    [SYMBOLS_LAYER] = LAYOUT_tkl_f13_ansi(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    _______,  _______,  _______,
    ...
    [NUMS_LAYER] = LAYOUT_tkl_f13_ansi(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    _______,  _______,  _______,
    ...
    [FUNCTION_KEYS_LAYER] = LAYOUT_tkl_f13_ansi(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    _______,  _______,  _______,
        ...
        _______,            _______,  _______,  MAKE_KB,  _______,  _______,  _______,   KC_F1,    KC_F2,    KC_F3,    _______,              _______,              _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,    _______,    _______,  _______,  _______),

    [MOUSE_LAYER] = LAYOUT_tkl_f13_ansi(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_WH_L,  KC_WH_D,  KC_WH_U,  KC_WH_R,  _______,  _______,    _______,    _______,  _______,  _______,
        _______,  _______,  _______,  MT(MOD_LCTL, KC_BTN2),  MT(MOD_LSFT, KC_BTN2),  _______,  KC_MS_L,  KC_MS_D,  KC_MS_U,  KC_MS_R,  _______,  _______,              _______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [NAVIGATIONS_LAYER] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [SYMBOLS_LAYER] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [NUMS_LAYER] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [FUNCTION_KEYS_LAYER] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
    [MOUSE_LAYER] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU)},
};
