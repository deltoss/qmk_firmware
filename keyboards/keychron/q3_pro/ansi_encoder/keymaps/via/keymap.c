...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [NAVIGATIONS_LAYER] = LAYOUT_tkl_f13_ansi(
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    _______,  _______,  _______,
        _______,  HL_HOME,  HL_UP,    HL_END,   REDO,     KC_TAB,   _______,  UNDO,     KC_INS,   LINE_BSPC,LINE_DEL, _______,  _______,    _______,    _______,  _______,  _______,
    ...
    [MOUSE_LAYER] = LAYOUT_tkl_f13_ansi(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    KC_WH_U,  _______,  KC_WH_D,
