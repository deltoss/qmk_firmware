...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
       KC_TAB,    KC_Q,    LT(MOUSE_LAYER, KC_W),    LT(MOUSE_LAYER, KC_E),    KC_R,    KC_T,                         KC_Y,    KC_U,    KC_I,    KC_O,   KC_P,  KC_INS,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      LT(FUNCTION_KEYS_LAYER, KC_ESC),    MT(MOD_LGUI, KC_A),    MT(MOD_LALT, KC_S),    MT(MOD_LCTL, KC_D),    MT(MOD_LSFT, KC_F),    KC_G,                         KC_H,    MT(MOD_RSFT, KC_J),    MT(MOD_RCTL, KC_K),    MT(MOD_RALT, KC_L), TD(TD_SEMICOLON), KC_DEL,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      LT(NAVIGATIONS_LAYER, S(KC_MINS)), LT(SYMBOLS_LAYER, KC_Z),    LT(NUMS_LAYER, KC_X),    KC_C,    KC_V,    KC_B,                         KC_N,    KC_M, TD(TD_COMMA),  TD(TD_DOT), TD(TD_SLASH),  TD(TD_QUOTE),
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          LT(NUMS_LAYER, S(KC_MINS)),   LT(SYMBOLS_LAYER, KC_TAB),  LT(NAVIGATIONS_LAYER, KC_SPC),     LT(NAVIGATIONS_LAYER, KC_ENT),   LT(SYMBOLS_LAYER, KC_TAB), LT(NUMS_LAYER, S(KC_MINS))
                                      //`--------------------------'  `--------------------------'
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______, MT_HL_LINE, MT_HL_LEFT, MT_HL_DOWN, MT_HL_RIGHT, KC_BSPC,           KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_HOME, KC_BSPC,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______, _______, LINE_BSPC, WORD_BSPC, KC_BSPC, _______,                    _______, KC_DEL, WORD_DEL, LINE_DEL, KC_END, _______,
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
